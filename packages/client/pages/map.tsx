...
// import { isInViewport } from "@hashtag-design-system/components";
...
//   // has been imporved and replaces by the fetchSearchValueCoords() of the Search Context
...
//         payload: { sortId: map.sort.id, beachBars: shownBeachBars, coords: viewport },
//       });
//   }, 1000);
...
//       <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit="initial" style={{ height: "100vh" }}>
//         <ReactMapGL
//           {...viewport}
