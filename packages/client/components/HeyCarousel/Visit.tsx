<<<<<<< HEAD:packages/client/components/HeyCarousel/Visit.tsx
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div className={styles.content + " w100 flex-column-flex-start-flex-start"}>
        ...
        <div className={styles.datesContainer + " w100"}>
            ...
            {uniqBy(visits, "date").map(({ date, isUpcoming, isRefunded }) => (
              <li key={"visit_" + date} className={styles.date + " flex-row-space-between-center"}>
                ...
                {isRefunded ? (
                  ...
                  isUpcoming && <span className="body-12 semibold">Upcoming</span>
                )}
              </li>
            ))}
          </ul>
...
Visit.displayName = "CarouselVisit";
>>>>>>> 3c094b84c4b6a5e6c8400166ac60b7393b7ddcff:packages/client/components/Carousel/Visit.tsx
