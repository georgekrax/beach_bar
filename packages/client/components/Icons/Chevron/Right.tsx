...
export const Path: React.FC<IconPathBaseFProps> = ({ ...props }) => {
  return <PathBase d="M7 21l10-9L7 3" strokeLinecap="round" strokeLinejoin="round" {...props} />;
};
...
Right.displayName = "IconChevronRight";
// Filled.displayName = "ChevronRightFilledIcon";
Path.displayName = "IconChevronRightPath";
