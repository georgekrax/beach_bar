...
import { PaymentOfferCodeType } from "./offer_code";
import { ReservedProductType } from "./reserved_product";
...
export const PaymentType = objectType({
  ...
  definition(t) {
    ...
    t.field("timestamp", { type: DateTimeScalar, description: "The timestamp recorded, when the payment was created / paid" });
  },
});
