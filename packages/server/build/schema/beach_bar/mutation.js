...
exports.BeachBarCrudMutation = void 0;
    ...
    definition(t) {
        t.field("addBeachBar", {
            ...
            args: {
                ...
                categoryId: nexus_1.idArg({ description: "The ID value of the category of the #beach_bar" }),
                openingTimeId: nexus_1.idArg({ description: "The ID value of the opening quarter time of the #beach_bar, in its country time zone" }),
                closingTimeId: nexus_1.idArg({ description: "The ID value of the closing quarter time of the #beach_bar, in its country time zone" }),
            ...
            resolve: (_, { name, description, thumbnailUrl, contactPhoneNumber, hidePhoneNumber, zeroCartTotal, categoryId, openingTimeId, closingTimeId, code, state, }, { payload, req, res, stripe, redis }) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!checkScopes_1.checkScopes(payload, ["beach_bar@crud:beach_bar"]))
                    throw new apollo_server_express_1.ApolloError(common_1.errors.NOT_REGISTERED_PRIMARY_OWNER, common_1.errors.UNAUTHORIZED_CODE);
                ...
                if (state !== req.cookies.scstate)
                    throw new apollo_server_express_1.ApolloError(common_1.errors.SOMETHING_WENT_WRONG + ": Please try again.", common_1.errors.SOMETHING_WENT_WRONG);
                if (zeroCartTotal === null || zeroCartTotal === undefined)
                    throw new apollo_server_express_1.ApolloError("Please provide if you allow your customers to purchase products and have zero (0) as their total price in cart", common_1.errors.INVALID_ARGUMENTS);
                if (!openingTimeId ||
                ...
                try {
                    ...
                    if (err.message === 'duplicate key value violates unique constraint "beach_bar_name_key"')
                        throw new apollo_server_express_1.ApolloError("A #beach_bar with this name already exists.", common_1.errors.CONFLICT);
                    if (err.message === "This authorization code has already been used. All tokens issued with this code have been revoked.")
                        throw new apollo_server_express_1.ApolloError(common_1.errors.SOMETHING_WENT_WRONG + ": Please try to repeat the process", common_1.errors.INTERNAL_SERVER_ERROR);
                    throw new apollo_server_express_1.ApolloError(common_1.errors.SOMETHING_WENT_WRONG + ": " + err.message);
                }
            }),
        });
        t.field("updateBeachBar", {
            type: types_2.UpdateBeachBarType,
            ...
            args: {
                ...
                isActive: nexus_1.nullable(nexus_1.booleanArg({ description: "Set to true if the #beach_bar is active" })),
                categoryId: nexus_1.nullable(nexus_1.idArg({ description: "The ID value of the category of the #beach_bar" })),
                openingTimeId: nexus_1.nullable(nexus_1.idArg({ description: "The ID value of the opening quarter time of the #beach_bar, in its country zone" })),
                closingTimeId: nexus_1.nullable(nexus_1.idArg({ description: "The ID value of the closing quarter time of the #beach_bar, in its country zone" })),
            },
            resolve: (_, { beachBarId, name, description, thumbnailUrl, contactPhoneNumber, hidePhoneNumber, zeroCartTotal, isAvailable, isActive, categoryId, openingTimeId, closingTimeId, }, { payload }) => __awaiter(this, void 0, void 0, function* () {
                if (!payload || !payload.sub)
                    throw new apollo_server_express_1.ApolloError(common_1.errors.NOT_AUTHENTICATED_MESSAGE, common_1.errors.NOT_AUTHENTICATED_CODE);
                if (!checkScopes_1.checkScopes(payload, ["beach_bar@crud:beach_bar", "beach_bar@update:beach_bar"]))
                    throw new apollo_server_express_1.ApolloError('You are not allowed to update "this" #beach_bar\'s details', common_1.errors.UNAUTHORIZED_CODE);
                ...
                try {
                    const updatedBeachBar = yield beachBar.update(name, description, thumbnailUrl, contactPhoneNumber, hidePhoneNumber, zeroCartTotal, isAvailable, isActive, categoryId, openingTimeId, closingTimeId);
                    return {
