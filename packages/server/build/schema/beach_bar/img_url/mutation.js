...
exports.BeachBarImgUrlCrudMutation = nexus_1.extendType({
    type: "Mutation",
    definition(t) {
        t.field("addBeachBarImgUrl", {
            ...
            args: {
                ...
                description: nexus_1.nullable(nexus_1.stringArg({
        ...
        t.field("updateBeachBaImgUrl", {
            ...
            args: {
                imgUrlId: nexus_1.idArg({ description: "The ID value of the #beach_bar's image" }),
