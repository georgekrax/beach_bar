...
export const ErrorObjectType = objectType({
  ...
  definition(t) {
    t.string("code", { nullable: true, description: "The error code of the operation, finded in a list in the documentation" });
    t.string("message", { nullable: false, description: "A short description for the error occured" });
  },
});
